...
public class HabitController {
     ...
     * @param comment comment of the habit
     * @param schedule the boolean array schedule
     * @return habit the newly created habit object
     */
    ...
    /**
     * This should edit the values in a habit adhering to constraints
     * @param habit Habit to be edited
     * @param name new name
     * @param comment new comment
     * @param schedule new schedule
     * @return returns an integer success/failure code
     */
